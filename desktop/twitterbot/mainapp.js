...
Twitter.stream('statuses/filter', {track: '@DearStellar'}, function(stream) {
	...
	stream.on('data', function(tweet) {
		...
		var errorMessage = "Hello @" + name + ". " + "We could not process your request. Please tweet in this format: @DearStellar balance YOUR-ACCOUNTID"; 
		...
		// reply string
		var reply = "Hi @" + name + ". " + "Your account balance has been sent to your dm."; 
		...
		var dm = "Hi @" + name + ". " + "Your account balance is " + balances;
